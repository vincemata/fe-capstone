    ...
    return (
      <group  ref={group} {...props} dispose={null}>
        <group position={[0.08, -0.29, -0.03]} rotation={[0, 1.47, 0]} scale={[-0.52, 0.52, 0.52]}>
          <mesh geometry={nodes.Slipper_1.geometry} material={materials.Footbed}  material-color={props.customColors.footbed} />
          <mesh geometry={nodes.Slipper_2.geometry} material={materials.Outsole} material-color={props.customColors.outsole} />
          <mesh geometry={nodes.Slipper_3.geometry} material={materials.Midsole} material-color={props.customColors.midsole} />
          <mesh geometry={nodes.Slipper_4.geometry} material={materials.Strap} material-color={props.customColors.strap} />
        </group>
      </group>
    )
                    ...
                    <Canvas shadows dpr={[1, 2]} camera={{ position: [0, 0, 80], fov:40  }}>
                      ...
                      <Stage environment="city" intensity={0.3}>
                          <spotLight intensity={0.9} 
                                     ...
                                     position={[10,15,10]}
                                     castShadow />
                          <Tsinelas customColors={{footbed:footbed, strap:strap,midsole:midsole,outsole:outsole }}/>
                          <BakeShadows />
                          </Stage>
